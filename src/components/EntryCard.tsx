    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-1.5">
          ...
          {aliveCount >= 0 && (
            <span className={`text-xs font-bold px-2 py-0.5 rounded-full border min-w-[90px] text-center ${
              aliveCount <= 3
              ...
              <span className="inline-flex w-5 justify-center">{aliveCount === 0 ? '🪦' : aliveCount <= 3 ? '🆘' : aliveCount <= 6 ? '🥵' : '⛽️'}</span>{aliveCount}/9 alive
            </span>
          )}
