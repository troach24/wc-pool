...
export function TodayMatches() {
  ...
  return (
    <div className="mb-3">
      <h2 className="text-xs font-bold uppercase tracking-wide text-gray-400 mb-2">Today's Matches</h2>
          ...
          return (
            <div
              ...
              className={`flex items-center gap-3 px-3 py-2 rounded-lg text-sm border ${
                live ? 'bg-red-50 border-red-200' : ended ? 'bg-gray-50 border-gray-200' : 'bg-white border-gray-200'
              }`}
            >
              ...
              <span className={`text-xs px-2 py-0.5 rounded-full font-medium ${
                ...
                ended ? 'bg-gray-200 text-gray-600' : 'bg-blue-100 text-blue-700'
              }`}>
